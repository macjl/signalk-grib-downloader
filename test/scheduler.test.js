...
const { expectedRunStamp, downloaderSourceConfig, MODEL_MAX_HOURS } = require('../dist/scheduler.js')
...
test('gfs source config: steps, bbox, resolution', () => {
  const c = downloaderSourceConfig(
    { name: 'gfs-025', model: 'gfs', hours: 384 },
    '/data',
